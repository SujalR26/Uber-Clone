...
const LookingForDriver = (props) => {
    ...
    return (
        <div>
           ...
           <h3 className="relative text-2xl font-semibold mb-2 text-center">
                Looking for Nearby Drivers
                 <span className=" absolute -bottom-4 left-0 h-1 w-full ">
                    <span className="block h-full  bg-blue-500 animate-loading"></span>
                </span>
        </h3>
